  ...
  return <FlexBetween flexWrap="wrap" gap={1}>
      ...
      <TabContext value={value}>
        <TabListWrapper variant="scrollable" onChange={changeTab}>
          <Tab disableRipple label="All Farmers" value={value} />
          {/* <Tab disableRipple label="Recently Updated" value={value} /> */}
      ...
      <Button variant="contained" startIcon={<Add />} onClick={() => navigate("/dashboard/users/add-farmer")}>
        Add New Farmer
      </Button>
    </FlexBetween>;
};
