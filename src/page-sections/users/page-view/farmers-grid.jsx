...
const FarmersGridPageView = () => {
  ...
  return <Box pt={2} pb={4}>
      ...
      py: 2
        ...
        <SearchArea value={userFilter.search} onChange={e => handleChangeFilter("search", e.target.value)} gridRoute="/dashboard/users/farmer-grid" listRoute="/dashboard/users/all-farmers" />
...
export default FarmersGridPageView;