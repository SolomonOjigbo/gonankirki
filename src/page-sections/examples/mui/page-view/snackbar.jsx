  ...
  return <ComponentPageLayout title="Snackbar">
      <Grid container spacing={3}>
        <Grid item lg={6} xs={12}>
          <Block title="Simple">
            <Stack direction="row" alignItems="center" justifyContent="center" spacing={3}>
              ...
              <Snackbar open={open[1]} onClose={handleClose(1)} autoHideDuration={2000} message="This is Gonankirki Snackbar" />
            </Stack>
          </Block>
        </Grid>
        ...
        <Grid item lg={6} xs={12}>
          <Block title="With Action">
            <Stack direction="row" alignItems="center" justifyContent="center" spacing={3}>
              ...
              <Snackbar open={open[2]} onClose={handleClose(2)} autoHideDuration={2000} message="This is Gonankirki Snackbar" action={<IconButton size="small" color="inherit" onClick={handleClose(2)}>
        ...
        <Grid item lg={6} xs={12}>
          ...
          }} open={state.open} onClose={handleCloseSnackbar} message="This is Gonankirki Snackbar" key={state.vertical + state.horizontal} />
          </Block>
        </Grid>
      </Grid>
    </ComponentPageLayout>;
